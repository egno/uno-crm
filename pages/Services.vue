...
export default {
  ...
  computed: {
    ...
    ...mapGetters({serviceGroups: 'service/serviceGroups', businessServiceCategories: 'business/businessServiceCategories', searchString: 'common/searchString', businessId: 'business/businessId',}),
    id () {
