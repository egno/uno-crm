...
export default {
  ...
  computed: {
    ...mapGetters({ businessId: 'business/businessId', businessInfo: 'business/businessInfo', businessIsFilial: 'business/businessIsFilial', searchString: 'common/searchString'}),
    clientId () {
