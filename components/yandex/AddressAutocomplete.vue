          ...
          this.items = res.data.response.GeoObjectCollection.featureMember
            ...
            .map((x) => {
              const addressComponents =
                x.GeoObject.metaDataProperty.GeocoderMetaData.Address &&
                x.GeoObject.metaDataProperty.GeocoderMetaData.Address.Components
              let city
              ...
              return {
                name:
                  x.GeoObject.metaDataProperty.GeocoderMetaData.Address
                    .formatted,
                city,
                cityAddress: x.GeoObject && x.GeoObject.name,
                addressComponents,
                point:
