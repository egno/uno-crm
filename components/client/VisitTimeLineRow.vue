<template>
  <v-layout
    class="client-visit-log"
    :class="{ [visit.status]: visit.status, done: status && status.done }"
  >
    <div class="client-visit-log__left">
    ...
    <div class="client-visit-log__right">
